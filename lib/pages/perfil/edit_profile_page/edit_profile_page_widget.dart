...
class _EditProfilePageWidgetState extends State<EditProfilePageWidget> {
  ...
  void initState() {
    ...
    _model.descricaoTextController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.descricao, ''));
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 40.0, 0.0),
                      child: Text(
                        'Altere os dados do seu perfil',
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          if ((_model.uploadedLocalFile_uploadData5xn0.bytes
                                      ?.isEmpty ??
                                  true))
                              ...
                              builder: (context) => InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadData5xn0 = true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadData5xn0 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadData5xn0 =
                          ...
                          if ((_model.uploadedLocalFile_uploadData5xn0.bytes
                            ...
                            ClipRRect(
                              borderRadius: BorderRadius.circular(40.0),
                              child: Image.memory(
                                _model.uploadedLocalFile_uploadData5xn0.bytes ??
                                    Uint8List.fromList([]),
                                width: 80.0,
                                height: 80.0,
                                fit: BoxFit.cover,
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowChoiceChips(
                                              ...
                                              controller: _model
                                                  ...
                                                  FormFieldController<
                                                      List<String>>(
                                                (currentUserDocument?.categorias
                                                        .toList() ??
                                                    []),
                                              ),
                                              wrapped: true,
                              ...
                              onPressed: () async {
                                ...
                                if (_model.generoValue == null) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Você precisa inserir seu gênero!',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                              font: GoogleFonts.inter(
                                ...
                                if ((_model.categoriaChoiceChipsValues!
                                  ...
                                  if ((_model.uploadedLocalFile_uploadData5xn0
                                              .bytes?.isNotEmpty ??
                                          false)) {
                                    {
                                      safeSetState(() =>
                                          _model.isDataUploading_uploadData4xt =
                                              true);
                                      var selectedUploadedFiles =
                                          <FFUploadedFile>[];
                                      ...
                                      try {
                                        selectedUploadedFiles = _model
                                                .uploadedLocalFile_uploadData5xn0
                                                .bytes!
                                                .isNotEmpty
                                            ? [
                                                _model
                                      ...
                                      if (selectedUploadedFiles.length ==
                                          ...
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_uploadData4xt =
                                              selectedUploadedFiles.first;
                                          _model.uploadedFileUrl_uploadData4xt =
                                              downloadUrls.first;
                                        });
                                      } else {
                                        safeSetState(() {});
