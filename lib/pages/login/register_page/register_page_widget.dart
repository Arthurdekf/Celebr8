              ...
              Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      context.pushNamed(RegisterOptionPageWidget.routeName);
                    },
                  ),
                  Expanded(
                    child: Align(
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        'Preencha os campos a seguir para se\ncadastrar na nossa plataforma',
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    if ((_model.uploadedLocalFile_uploadData5xn5
                                                .bytes?.isNotEmpty ??
                                            false))
                                      ClipRRect(
                                        borderRadius:
                                        ...
                                        child: Image.memory(
                                          _model.uploadedLocalFile_uploadData5xn5
                                                  .bytes ??
                                              Uint8List.fromList([]),
                                          width: 80.0,
                                          height: 80.0,
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_uploadData5xn5 =
                                                true);
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadData5xn5 =
                                                  false;
                                            }
                              ...
                              onPressed: () async {
                                ...
                                if ((_model.uploadedLocalFile_uploadData5xn5
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Você precisa de uma foto de perfil!',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(
                                              font: GoogleFonts.inter(
                                ...
                                if ((_model.categoriaChoiceChipsValues!
                                  ...
                                  await UserRecord.collection
                                    ...
                                    ...createUserRecordData(
                                      ...
                                      dataDeNascimento: _model.datePicked,
                                    ),
                                    ...mapToFirestore(
                                      {
                                        'categorias':
                                  ...
                                  {
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataH41 = true);
                                    var selectedUploadedFiles =
                                        <FFUploadedFile>[];
                                    ...
                                    try {
                                      selectedUploadedFiles = _model
                                              .uploadedLocalFile_uploadData5xn5
                                              .bytes!
                                              .isNotEmpty
                                          ? [
                                              _model
                                      ...
                                      _model.isDataUploading_uploadDataH41 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                            selectedMedia.length &&
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadDataH41 =
                                            selectedUploadedFiles.first;
                                        _model.uploadedFileUrl_uploadDataH41 =
                                            downloadUrls.first;
                                      });
                                    } else {
                                      safeSetState(() {});
