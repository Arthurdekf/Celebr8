...
import 'schema/eventos_confirmacoes_record.dart';
...
export 'schema/eventos_confirmacoes_record.dart';
...
/// Functions to query EventosConfirmacoesRecords (as a Stream and as a Future).
Future<int> queryEventosConfirmacoesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EventosConfirmacoesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EventosConfirmacoesRecord>> queryEventosConfirmacoesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EventosConfirmacoesRecord.collection,
      EventosConfirmacoesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EventosConfirmacoesRecord>> queryEventosConfirmacoesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
