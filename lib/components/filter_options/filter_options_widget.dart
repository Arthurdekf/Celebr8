                              ...
                              child: FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    ...
                                    options:
                                        List<String>.from(GetEstadosCall.sigla(
                                      dropDownEstadoGetEstadosResponse.jsonBody,
                                    )!),
                                    optionLabels: GetEstadosCall.nome(
                                      dropDownEstadoGetEstadosResponse.jsonBody,
                                    )!,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FutureBuilder<ApiCallResponse>(
                                future: GetCidadesPorEstadoCall.call(
                                  sigla: _model.dropDownEstadoValue,
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    ...
                                    options: GetCidadesPorEstadoCall.nome(
                    ...
                    child: StreamBuilder<List<CategoriasRecord>>(
                      stream: queryCategoriasRecord(
                        queryBuilder: (categoriasRecord) =>
                            categoriasRecord.orderBy('nomeCategoria'),
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                        ...
                        return FlutterFlowChoiceChips(
                          options: categoriaChoiceChipsCategoriasRecordList
                              .map((e) => e.nomeCategoria)
                              .toList()
                              .map((label) => ChipData(label))
                              .toList(),
                          onChanged: (val) => safeSetState(
                              () => _model.categoriaChoiceChipsValues = val),
                          ...
                          multiselect: true,
                          initialized:
                              _model.categoriaChoiceChipsValues != null,
                          alignment: WrapAlignment.start,
                          controller:
                              _model.categoriaChoiceChipsValueController ??=
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            FFAppState().filtroCategoria = _model
